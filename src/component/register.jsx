    ...
    return (
        <div className="flex bg-white">
            ...
            <div className="bg-white flex flex-grow flex-col justify-center items-center h-screen">
                ...
                <button className="bg-button-2 hover:bg-purple-600 text-white h-10 w-28 mb-4 rounded-full shadow-md hover:shadow-purple-600 shadow-button-2">Sign Up</button>
